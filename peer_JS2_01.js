...
//console.log("value: " + value + "; backAdd: " + backAdd);

value=parseInt(value);
backAdd=parseInt(backAdd);
//console.log("value: " + value + "; backAdd: " + backAdd);
...
7. parseInt both the 'value' and the new variable created in Step 6, ensure that both 'value' and the 
new variable are set to these new parsed values;
